...
def get_school_recommendations(test_indices):    
    ...
    laptops = pd.read_csv('home/ubuntu/Box/Delta/Miscelleneous/Datasets/laptops_with_colors.csv')
    laptops.reset_index()
...
def get_hospital_recommendations(test_indices):    
    hospital_laptops = pd.read_csv("home/ubuntu/Box/Delta/Miscellaneous/Datasets/hospital_laptops.csv", index_col="Laptop_id") 
    laptops = pd.read_csv('home/ubuntu/Box/Delta/Miscellaneous/Datasets/laptops_with_photo_url.csv')
    laptops.reset_index()
    photos = laptops['photo_url']
    counter = 0
    indi_dicts = []
...
def location_similarity(location, company_type):
    ...
    if(company_type == "Education"):
        schools = pd.read_csv("home/ubuntu/Box/Delta/Miscellaneous/Datasets/schools_users.csv",index_col="company_id")
        school_orders = pd.read_csv("home/ubuntu/Box/Delta/Miscellaneous/Datasets/school_orders.csv")
        ...
        hospitals = pd.read_csv("home/ubuntu/Box/Delta/Miscellaneous/Datasets/hospitals_users.csv",index_col="company_id")
        hospital_orders = pd.read_csv("home/ubuntu/Box/Delta/Miscellaneous/Datasets/hospital_orders.csv")
